...
export default function LoginPage() {
  ...
  return (
    <AuthLayout>
      ...
      <div className="mt-6">
        <div className="relative">
          <Separator className={theme.colors.form.separator} />
          <div className="absolute inset-0 flex items-center justify-center">
            <span
              className={`${theme.colors.background.card} px-2 ${theme.colors.text.muted} text-xs`}
            >
              OR
            </span>
          </div>
        ...
        <div className="mt-4 space-y-2">
          <Button
            variant="outline"
            className={`w-full ${theme.classes.button.secondary}`}
          >
